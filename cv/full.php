<?php require '../assets/php/loginCheck.php'; ?>
    ...
    <div class="content">
        ...
        <div class="box-container">
            <div class="box">
              ...
              <p><span> Phone : </span> +27 81 470 1672</p>
            </div>
            <div class="box">
        ...
        <div class="resumebtn">
            <a href="/assets/cv/SJ Pretorius.pdf" target="_blank" class="btn"><span>Resume</span>
...
<section class="education" id="education">
  ...
  <h1 class="heading-education"><i class="fas fa-graduation-cap"></i> My <span>Education</span></h1>
    ...
    <div class="box">
      ...
      <div class="content">
      <h3>National Senior Certificate (Bachelors Pass)</h3>
      <p>Cradock High School | Cradock</p>
...
<section class="experience" id="experience">
  ...
  <div class="timeline">
    ...
    <div class="container left">
      <div class="content">
        <div class="tag">
          <h2>Cradock High School</h2>
        </div>
        <div class="desc">
            <h3>School Sound Engineer and Informal IT Technician</h3>
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          <h3>Contact info</h3>
          <p> <i class="fas fa-phone"></i>+27 81 470 1672</p>
